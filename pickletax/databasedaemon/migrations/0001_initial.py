# Generated by Django 2.2 on 2019-05-15 15:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('лекционная', 'леционаая'), ('семинарская', 'семинарская'), ('лаборатория', 'лаюоратория'), ('для сотрудников', 'для сотрудников')], default='семинарская', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vacant', models.CharField(choices=[('свободны', 'свободна'), ('зарезервирована', 'зарезервирована'), ('занята', 'занята')], default='свободна', max_length=20)),
                ('info', models.CharField(blank=True, max_length=500)),
                ('campus_ID', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='databasedaemon.Campus')),
